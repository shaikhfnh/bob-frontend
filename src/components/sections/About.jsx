...
export default function About() {
  ...
  return (
    <section id="about" ref={ref} className="w-full bg-white px-6 py-10 md:p-16">
      <ParallaxSection intensity={25} tint="from-red-100/80">
        <motion.div
        ...
        >
          ...
          <div className="mt-6">
            <Button
              variant="primary"
              onClick={() => {
                logFunnelEvent('session_card_click', null, 'about_cta');
